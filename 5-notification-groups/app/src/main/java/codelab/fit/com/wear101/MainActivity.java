...
public class MainActivity extends Activity {
    ...
    public void showBigStyleNotification(final View button) {
        createBigStyleNotification("Test", "This is a big style notification, you should see this by default. How cool is that, right? Adding more text, because why not?");
    }

    public void showNotificationGroup(final View button) {
        createNotificationGroup("Test Group", "I'm a nice and cool notification!", "Hey I'm a cool notification too!");
    }
    ...
    private void createBigStyleNotification(final String title, final String content) {
        // An id for the notification to be showed, it should be unique.
        ...
        // description that may not fit the normal content text.
        final NotificationCompat.BigTextStyle bigStyle = new NotificationCompat.BigTextStyle();
        bigStyle.setBigContentTitle("A big notification");
    ...
    private void createNotificationGroup(final String title, final String content1, final String content2) {
        // An id for the notification to be showed, it should be unique.
        ...
        // Build a second notification, setting the group appropriately
        final Notification notification2 = new NotificationCompat.Builder(this)
                .setContentTitle("Another one!")
        ...
        final Notification summary = new NotificationCompat.Builder(this)
                .setContentTitle("2 new notifications")
                .setSmallIcon(R.drawable.ic_launcher)
                .setStyle(new NotificationCompat.InboxStyle()
                        .addLine("Homer Simpson   Do'h!")
                        .addLine("Milhouse   Re: Skinner prank")
                        .setBigContentTitle("2 new messages")
                        .setSummaryText("bart.simpson@gmail.com"))
                .setGroup(GROUP_KEY_EMAILS)
